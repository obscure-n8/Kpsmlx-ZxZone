...
class ZxZoneStyle:
    ...
    ST_BN1_NAME = '🤖 Repo'
    ST_BN1_URL = 'https://github.com/obscure-n8/ZxZone-Master-MLTB'
    ST_BN2_NAME = 'Updates 🔥'
    ST_BN2_URL = 'https://t.me/zxzoneupdates'
...
Type {help_command} to get a list of available commands</b>'''
    ...
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own ZxZone-Master-MLTB Mirror-Leech bot</i>'''
